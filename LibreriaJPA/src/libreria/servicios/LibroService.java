...
public class LibroService {
    ...
    public void buscarLibroPorISBN(){
        ...
        Libro libro = dl.buscarLibroPorISBN(isbn);
     ...
     public void buscarLibroPorTitulo(){
        ...
        Libro libro = dl.buscarLibroPorTitulo(titulo);
        System.out.println(libro.toString());
    }
     
     public void buscarLibroNombreAutor(){
         System.out.println("Ingrese nombre de autor:");
         String nombre = leer.next();
         List<Libro> listaLibros = dl.buscarLibroNombreAutor(nombre);
      ...
      public void buscarLibroNombreEditorial(){
         System.out.println("Ingrese nombre de editorial:");
         String nombre = leer.next();
         List<Libro> listaLibros = dl.buscarLibroNombreEditorial(nombre);
         for (Libro aux : listaLibros) {
             System.out.println(aux.toString());
         }
